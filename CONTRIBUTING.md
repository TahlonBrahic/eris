...
[MPL-2.0](http://mozilla.org/MPL/2.0), the license used by eris.
...
- Update documentation accordingly. Everything in `eris.lib` should be documented.
- Add [tests](https://github.com/TahlonBrahic/eris/tree/main/tests) when necessary.
  Test your changes with `nix flake check`. Make sure new files are added to git.

## Documentation

Documentation sits in the [docs](https://github.com/TahlonBrahic/eris/tree/main/docs)
...
Eris only depends on [nixpkgs.lib](https://github.com/TahlonBrahic/nixpkgs.lib).
...
- Format all Nix files with [nixpkgs-fmt](https://github.com/TahlonBrahic/nixpkgs-fmt).
